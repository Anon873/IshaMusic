        ...
        if name[0:3] == "sta":
            ...
            def get_stats():
                ...
                for vidid, count in list_arranged.items():
                    ...
                    if vidid == "telegram":
                        msg += f"🔗[ᴛᴇʟᴇɢʀᴀᴍ ᴍᴇᴅɪᴀ](https://t.me/Royal_x_Friends) ** ᴩʟᴀʏᴇᴅ {count} ᴛɪᴍᴇs**\n\n"
                    else:
...
💖 sᴇᴀʀᴄʜ ᴩᴏᴡᴇʀᴇᴅ ʙʏ {config.MUSIC_BOT_NAME}"""
            key = InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton(
                            text="• sᴜᴩᴩᴏʀᴛ •", url="https://t.me/Royal_x_Friends"
                        ),
                    ],
                ]
            )
        ...
        if config.START_IMG_URL:
            try:
                await message.reply_sticker("CAACAgEAAxkBAAEC_KdknVLGvIUvLPXDk84qhNsCrlbMnAACqwIAAh_-KEUpkEvboZ39Vi8E")
